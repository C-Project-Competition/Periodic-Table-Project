/*Periodic table finalized program:*/
#include <conio.h>
#include <string.h>
#include <stdio.h>
#include <windows.h>
    ...
    switch(n)
    {
              case 1: printf("\n\n\n\n\n\t\tEnter the atomic number of the element: ");
                      ...
                      for(i=1;i<=114;++i)
                      {
                         ...
                         printf("\t\t       Atomic Number       ");printf("%hd", (elem[i].atomicno));printf("\n");
                         printf("\t\t Electronic Configuration  ");puts(elem[i].ec);
                         printf("\t\t         Group             ");printf("%hd", (elem[i].group));printf("\n");
                         printf("\t\t         Period            ");printf("%hd", (elem[i].period));printf("\n");
                         printf("\t\t         Block             ");printf("%c", (elem[i].block));printf("\n");
                         printf("\t\t      Atomic Weight        ");printf("%.3f",(elem[i].atomicw));printf("\n");
                         if(elem[i].atomicr==0)
                         {printf("\t\t      Atomic Radius        Not Available\n");}
                         else
                         {printf("\t\t      Atomic Radius        ");printf("%hd", (elem[i].atomicr));printf("\n");}
                         if(elem[i].en==0)
                         {printf("\t\t    Electronegativity      Not Available\n");}
                         else
                         {printf("\t\t    Electronegativity      ");printf("%.3f",(elem[i].en));printf(" (Pauling Scale)\n");}
                         if(elem[i].meltp==0)
                         {printf("\t\t       Melting Point       Not Available\n");}
                         else
                         {printf("\t\t       Melting Point       ");printf("%.3f",(elem[i].meltp));printf("K\n");}
                         if(elem[i].boilp==0)
                         {printf("\t\t       Boiling Point       Not Available\n");}
                         else
                         {printf("\t\t       Boiling Point       ");printf("%.3f",(elem[i].boilp));printf("K\n");}
                         if(elem[i].density==0)
                         {printf("\t\t         Density           Not Available\n");}
                         else
                         {printf("\t\t         Density           ");printf("%.3f",(elem[i].density));printf(" gm/cm3\n");}
                         goto end;
                         }
                      }
                      printf("\n\t\t\t   Please try again");
                      ...
                      goto one;
                      break;
              case 2: printf("\t   Enter the element name given by the following format: \n\n");
